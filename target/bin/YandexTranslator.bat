...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="YandexTranslator" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" TelegramApiConnection.Initializations %CMD_LINE_ARGS%
